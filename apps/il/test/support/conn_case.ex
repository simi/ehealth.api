defmodule Il.Web.ConnCase do
  ...
  using do
    quote do
      ...
      import Il.Web.ConnCase
      import IlWeb.Router.Helpers
      import Il.Test.Support.Fixtures
      import Il.Factories

      # The default endpoint for testing
      @endpoint Il.Web.Endpoint
    end
  end
  ...
  setup tags do
    ...
    :ok = Ecto.Adapters.SQL.Sandbox.checkout(Il.Repo)
    :ok = Ecto.Adapters.SQL.Sandbox.checkout(Il.PRMRepo)

    unless tags[:async] do
      Ecto.Adapters.SQL.Sandbox.mode(Il.Repo, {:shared, self()})
      Ecto.Adapters.SQL.Sandbox.mode(Il.PRMRepo, {:shared, self()})
    end
