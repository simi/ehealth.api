defmodule Il.Integration.DeduplicatingPersonsTest do
  @moduledoc false
  ...
  describe "found_duplicates/0" do
    ...
    test "duplicate persons are marked as MERGED, declarations are deactivated", %{conn: conn} do
      _result = capture_log fn ->
        response = post(conn, "/internal/deduplication/found_duplicates")
      ...
      # TODO Currently log is empty (but it hits the mocked endpoint)
