defmodule Il.DeclarationRequest.Terminator do
  @moduledoc """
  ...
  import Il.DeclarationRequest.API, only: [terminate_declaration_requests: 0]

  # Client API

  @config Confex.get_env(:il, __MODULE__)
  ...
  defp schedule_next_run(ms) do
    unless Application.get_env(:il, :env) == :test do
