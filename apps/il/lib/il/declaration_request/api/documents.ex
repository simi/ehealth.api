defmodule Il.DeclarationRequest.API.Documents do
  @moduledoc false

  alias Il.DeclarationRequest
  alias Il.DeclarationRequest.API.Helpers
  ...
  def render_links(declaration_request_id, http_verbs, documents_list) do
    bucket = Confex.fetch_env!(:il, Il.API.MediaStorage)[:declaration_request_bucket]
