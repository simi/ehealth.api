defmodule Il.DeclarationRequest.API.Validations do
  @moduledoc false

  import Ecto.Changeset
  import Il.Utils.TypesConverter, only: [string_to_integer: 1]

  alias Il.DeclarationRequest
  alias Il.API.OTPVerification
  alias Il.Validators.Addresses
  alias Il.Validators.BirthDate
  alias Il.Validators.TaxID
  alias Il.API.Signature
  alias Il.DeclarationRequest.SignRequest
