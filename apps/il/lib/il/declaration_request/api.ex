defmodule Il.DeclarationRequest.API do
  @moduledoc false

  import Ecto.{Query, Changeset}, warn: false
  import Il.DeclarationRequest.API.Validations
  ...
  alias Il.DeclarationRequest.API.Create
  alias Il.DeclarationRequest.API.Approve
  alias Il.DeclarationRequest.API.Helpers, as: DeclarationHelpers
  alias Il.DeclarationRequest.API.Validations
  alias Il.DeclarationRequest.API.Sign
  alias Il.DeclarationRequest.API.ResendOTP
  alias Il.DeclarationRequest.API.Documents
  alias Il.Utils.Phone
  alias Il.Utils.Helpers
  ...
  def update_changeset(%Il.DeclarationRequest{} = declaration_request, attrs) do
  ...
  def pending_declaration_requests(nil, employee_id, legal_entity_id) do
    from p in Il.DeclarationRequest,
