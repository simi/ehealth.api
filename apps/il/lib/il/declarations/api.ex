defmodule Il.Declarations.API do
  @moduledoc false

  import Il.Utils.Connection, only: [get_client_id: 1]
  import Il.Plugs.ClientContext, only: [get_context_params: 2]
  import Il.Declarations.View, only: [render_declarations: 1, render_declaration: 1]
