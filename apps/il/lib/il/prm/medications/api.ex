defmodule Il.PRM.Medications.API do
  @moduledoc """
  ...
  alias Il.PRM.Medications.INNM.Search, as: INNMSearch
  alias Il.PRM.Medications.INNMDosage.Schema, as: INNMDosage
  alias Il.PRM.Medications.INNMDosage.Search, as: INNMDosageSearch
  alias Il.PRM.Medications.Medication.Ingredient, as: MedicationIngredient
  alias Il.PRM.Medications.Medication.Schema, as: Medication
  alias Il.PRM.Medications.Medication.Search, as: MedicationSearch
  alias Il.PRM.Medications.Program.Schema, as: ProgramMedication
  alias Il.PRM.Medications.Program.Search, as: ProgramMedicationSearch
  alias Il.PRM.MedicalPrograms.Schema, as: MedicalProgram
  alias Il.PRM.Medications.DrugsSearch
  alias Il.Validators.JsonSchema
  alias Il.PRM.Medications.Validator
