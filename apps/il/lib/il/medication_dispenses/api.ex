defmodule Il.MedicationDispense.API do
  @moduledoc false

  import Il.Utils.Connection, only: [get_client_id: 1, get_consumer_id: 1]
  ...
  alias Il.API.OPS
  alias Il.MedicationDispenses.Search
  alias Il.MedicationDispenses.SearchByMedicationRequest
  alias Il.Validators.JsonSchema
  alias Il.Validators.Reference
  alias Il.PRM.PartyUsers
  alias Il.PRM.Parties
  alias Il.PRMRepo
  alias Il.MedicationRequests.API, as: MedicationRequests
