defmodule Il.MedicationRequestRequests do
  @moduledoc """
  ...
  alias Il.MedicationRequestRequest
  alias Il.MedicationRequestRequest.Operation
  alias Il.MedicationRequestRequest.Validations
  alias Il.MedicationRequestRequest.SignOperation
  alias Il.MedicationRequestRequest.CreateDataOperation
  alias Il.MedicationRequestRequest.RejectOperation
  alias Il.MedicationRequestRequest.HumanReadableNumberGenerator, as: HRNGenerator

  @status_new Il.MedicationRequestRequest.status(:new)
  @status_signed Il.MedicationRequestRequest.status(:signed)
  @status_expired Il.MedicationRequestRequest.status(:expired)
  @status_rejected Il.MedicationRequestRequest.status(:rejected)
  ...
  def autoterminate do
    Repo.update_all(termination_query(), set: [
        ...
        updated_by: Confex.fetch_env!(:il, :system_user)
        ])
  end

  defp termination_query do
    minutes = Confex.fetch_env!(:il, :medication_request_request)[:expire_in_minutes]
