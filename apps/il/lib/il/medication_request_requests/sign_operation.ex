defmodule Il.MedicationRequestRequest.SignOperation do
  @moduledoc false
  import Il.MedicationRequestRequest.OperationHelpers

  alias Il.API.OPS
  alias Il.Utils.Connection
  alias Il.API.MediaStorage
