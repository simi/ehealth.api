defmodule Il.Web.MedicationDispenseView do
  @moduledoc false

  use Il.Web, :view
  alias Il.Web.LegalEntityView
  alias Il.Web.DivisionView
  alias Il.Web.MedicalProgramView
  alias Il.Web.MedicationRequestView
  alias Il.Web.PartyView
