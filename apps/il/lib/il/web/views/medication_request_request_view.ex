defmodule Il.Web.MedicationRequestRequestView do
  @moduledoc false
  use Il.Web, :view
  alias Il.Web.MedicationRequestRequestView
  alias Il.Web.{PersonView, EmployeeView, LegalEntityView, DivisionView, MedicalProgramView, INNMDosageView}
