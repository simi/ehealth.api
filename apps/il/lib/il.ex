defmodule Il do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(Il.DuplicatePersons, []),
      supervisor(Il.Repo, []),
      supervisor(Il.PRMRepo, []),
      # Start the endpoint when the application starts
      supervisor(Il.Web.Endpoint, []),
      worker(Il.DeclarationRequest.Terminator, []),
      worker(Il.EmployeeRequest.Terminator, []),
      worker(Il.Scheduler, [])
      # Starts a worker by calling: Il.Worker.start_link(arg1, arg2, arg3)
      # worker(Il.Worker, [arg1, arg2, arg3]),
    ]

    # See http://elixir-lang.org/docs/stable/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: Il.Supervisor]
